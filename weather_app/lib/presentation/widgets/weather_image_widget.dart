...
bool isNight(dt, sunrise, sunset) {
  int dtMin = DateTime.fromMicrosecondsSinceEpoch(dt * 1000000).hour * 60 +
      DateTime.fromMicrosecondsSinceEpoch(dt * 1000000).minute;
  int sunriseMin =
      DateTime.fromMicrosecondsSinceEpoch(sunrise * 1000000).hour * 60 +
          DateTime.fromMicrosecondsSinceEpoch(sunrise * 1000000).minute;
  int sunsetMin =
      DateTime.fromMicrosecondsSinceEpoch(sunset * 1000000).hour * 60 +
          DateTime.fromMicrosecondsSinceEpoch(sunset * 1000000).minute;
