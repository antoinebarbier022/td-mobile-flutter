            ...
            Container( // Container for Header (score and index)
              ...
              child: Row(
                ...
                children: [
                  ...
                  builder: (_, index) {
                    return Center(
                      child: Text('Question ${index+1}/${game.getNbQuestions()}', 
            ...
            BlocBuilder<NextQuestionCubit, int>(
                  builder: (_, index) {
                    ...
                    BlocBuilder<AnswerQuestionCubit, int>(
                      builder: (_, answer) {
                        return Container( // Container for Questions
                            width:350,
                            height:150,
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                width: 2.0, 
                                color: answer == 2 ? Colors.blueGrey.shade200 : (answer == 1 ? Colors.green : Colors.red), )
                            ),
                            child: Text(game.getQuestion(index), 
                                          style: const TextStyle(fontSize: 18),
            ...
            Container( // Container for Buttons
              ...
              child: BlocBuilder<NextQuestionCubit, int>(
                  ...
                  builder: (_, answer) {
                    ...
                    children: [
                      ElevatedButton(
                            onPressed: answer != 2 ? null : () => checkAnswer(context, index, true),
                            child: const Text("Vrai", style: TextStyle(fontSize: 18)),
                          ),

                      ElevatedButton(
                            // si c'est la fin du quiz on reset
                              onPressed: answer != 2 ? null : () => checkAnswer(context, index, false),
                    ...
                    ElevatedButton(
                            // si c'est la fin du quiz on reset
                              onPressed: answer == 2 ? null : () => nextQuestion(context, index),
                              child: Wrap(children:  [
                                  Text(index+1 == game.getNbQuestions() ? "Recommencer" :"Suivant", style: const TextStyle(fontSize: 18)),
